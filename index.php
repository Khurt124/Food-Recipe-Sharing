  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Discover your favorite recipes</h1>
        <p class="lead text-body-secondary">Explore diverse, mouth-watering recipes curated to satisfy every palate and inspire culinary creativity in every kitchen, from breakfast to dinner.</p>
      </div>
    </div>
  </section>
                    ...
                    foreach ($publishedRecipes as $recipe) {
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                <img src="<?php echo $recipe['image_path']; ?>" class="bd-placeholder-img card-img-top" width="100%" height="225" role="img" aria-label="Recipe Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo $recipe['title']; ?></h5>
                                    <p class="card-text"><?php echo $recipe['description']; ?></p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group col-12">
                                            <a href="view_recipe.php?id=<?php echo $recipe['id']; ?>" class="btn btn-dark btn-block">View</a>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    searchForm.addEventListener("submit", function(event) {
        ...
        debugInfo.textContent = "Submitting...";
    });
});
</script>
